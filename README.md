...
#%%
```
6. Iterasi dilakukan hingga seluruh syarat batas terpenuhi.
```
#Iterasi
for n in range (0, Nt):
...
#%%
```
8. _Script output_ gambar dibuat untuk mendapatkan gambar penyebaran polutan.
```
#Output Gambar
    plt.clf()
